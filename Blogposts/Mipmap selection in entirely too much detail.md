...
The more shallow the viewing angle, the larger the derivatives get. Additionally, the derivatives are larger further away from the camera. ![](PixelDerivatives.gif)
...
![](MipSelectionComparison.gif)
And here is with 16x anisotropic filtering:
![](AnisoMipComparison.gif)
